...
export default function Home() {
  ...
  return (
    <main className="max-w-3xl mx-auto py-10 px-4 space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">KnowledgeForge</h1>
        <p className="text-muted-foreground mt-1">
          Upload your study materials and create study sets for adaptive learning.
        </p>
      </div>
      ...
      <StudySetList corpora={corpora} selectedDocIds={selectedDocIds} onRefresh={refreshCorpora} />
    </main>
  );
}
